...
--
-- DATI STANDARD
-- I dati standard vengono inseriti in fase di installazione del framework e non vanno modificati
-- successivamente dall'utente.
--
-- DATI DI SUPPORTO
-- i dati di supporto vengono inseriti in fase di installazione del framework ma possono essere modificati
-- successivamente dall'utente. Sono inseriti principalmente perché senza sarebbe difficile o impossibile
-- utilizzare il framework, ma il loro ruolo è legato alle specificità del singolo progetto e quindi possono
-- essere modificati sia in fase di setup sia successivamente durante l'uso del programma.
--
