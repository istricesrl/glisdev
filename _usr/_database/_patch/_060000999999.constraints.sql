...
ALTER TABLE `prezzi`
    ...
    ADD CONSTRAINT `prezzi_ibfk_03`    FOREIGN KEY (`id_listino`) REFERENCES `listini` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    ADD CONSTRAINT `prezzi_ibfk_04`    FOREIGN KEY (`id_iva`) REFERENCES `iva` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    ADD CONSTRAINT `prezzi_ibfk_05`    FOREIGN KEY (`id_reparto`) REFERENCES `reparti` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
